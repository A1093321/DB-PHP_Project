							...
							<!-- Buttons -->
								...
								<center>
									<ul class="actions fit">
										...
										<li><a href="insert.php" class="button primary fit">新增產品</a></li>
										<li><a href="delete.php" class="button primary fit">刪除產品</a></li>
										<li><a href="update.php" class="button primary fit">修改產品資料</a></li>

									</ul>
									<br><br>
									<h2><a href="index.php" class="button fit">登出</a></h2>
								</center>
								</section>
						</div>
					</div>
