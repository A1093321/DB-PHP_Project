...
$sql="SELECT * FROM product WHERE type = 'CPU' ORDER BY price DESC";
			...
			<div id="wrapper">
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							<h2>CPU</h2>
							<p>中央處理器 （英語：Central Processing Unit，縮寫：CPU）是電腦的主要裝置之一，功能主要是解釋電腦指令以及處理電腦軟體中的資料。</p>
							<section class="tiles">
							<?php
							while ($row = mysqli_fetch_array($result)){ 
								echo '<article class="style">';
									echo '<span class="image">';
										echo '<img src="images/pic09.jpg" alt="" />';
									echo '</span>';
									echo '<a href="">';
