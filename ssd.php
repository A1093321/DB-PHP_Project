...
$sql="SELECT * FROM product WHERE type = 'SSD' ORDER BY price DESC";
			...
			<div id="wrapper">
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							<h2>SSD</h2>
							<p>固態硬碟或固態驅動器（英語：Solid-state drive或Solid-state disk，簡稱SSD）是一種以積體電路製作的電腦儲存裝置。</p>
							<section class="tiles">
							<?php
							while ($row = mysqli_fetch_array($result)){ 
								echo '<article class="style">';
									echo '<span class="image">';
										echo '<img src="images/pic07.jpg" alt="" />';
									echo '</span>';
									echo '<a href="">';
